  ...
  return (
    <section className="py-16 sm:py-24 px-6 bg-background">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-14">
          ...
          <div className="sm:text-right">
            ...
            <p className="text-sm text-muted-foreground font-light max-w-[200px] sm:ml-auto leading-relaxed">
              Excellence in every detail, elegance in every moment.
            </p>
          </div>
        </div>
        ...
        >
          {/* Text */}
          <div className="bg-background p-10 sm:p-14 flex flex-col justify-center relative overflow-hidden order-1 md:order-1">
            {/* Ghost initial */}
            <span
          ...
          {/* Image */}
          <div className="overflow-hidden bg-background aspect-square order-2 md:order-2">
            <img
              src={aboutImg}
